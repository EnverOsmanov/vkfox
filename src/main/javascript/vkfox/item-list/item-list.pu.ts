...
function itemListRepeat($parse, $animate, $timeout) {
    ...
    return {
        ...
        compile   : function (element, attr, linker) {
            return function ($scope, $element, $attr, itemListController) {
                ...
                if (!match) {
                    throw new Error("Expected itemListRepeat in form of '_item_ in _collection_[ Tracker by _id_]' but got '" +
                        expression + "'.");
                }
                ...
                function updateScrolledBlocks(collection, cursor, nextBlockOrder, nextBlockMap, offset?: number) {
...
export default function init() {
     ...
     */
        ...
        .directive('itemListRepeat', ['$parse', '$animate', '$timeout', itemListRepeat]);
}
